        ...
        if (!product) {
            return (
                <div className="details-card">
                    ...
                    <p className="details-note">The item you are looking for does not exist or may have been removed.</p>
                </div>
            );
        }
    ...
    return (
        <section className="page-panel product-details-page">
            <div className="page-heading">
                ...
                <p>View full details on the selected product and return to the product catalog anytime.</p>
            </div>

            {renderContent()}

            <div className="details-footer">
                <Link className="primary-btn" to="/">Back to catalog</Link>
            </div>
        </section>
    );
}
